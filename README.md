...
Interesada en oportunidades Junior / Trainee en entornos tecnológicos y de consultoría.
...
**Backend:** PHP  
**Database:** SQL · MySQL · PL/SQL (académico)  
**Tools:** Git · GitHub · Jira · Visual Studio Code  
**Methodologies:** Scrum
...
Proyecto académico grupal desarrollado bajo metodología Scrum.

- Desarrollo de funcionalidades frontend y backend
- Interfaz responsive
- Implementación de lógica de negocio y consultas SQL
- Trabajo en equipo bajo Scrum con sprints quincenales
- Proyecto publicado y funcional
...
- Lideré un equipo de 5 personas organizando el trabajo en sprints quincenales
- Definición de tareas, plazos y objetivos utilizando Jira
- Participación activa en frontend y backend
- Control de versiones con GitHub
- Elaboración de documentación técnica y de gestión
- Uso de consultas SQL y modelado de datos relacionales
